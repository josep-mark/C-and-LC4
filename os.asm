...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; TRAP_GETC - Check for a character from the keyboard
;;; Inputs    - R1 = address for the character array to fill
;;; Outputs   - R1
...
TRAP_GETS
	...
	TRAP_GETS_LOOP
	LC R3, OS_KBSR_ADDR 	; Get keyboard status register address
	LDR R3, R3, #0  		; Load keyboard status register contents
	BRZP TRAP_GETS_LOOP		; If status register is 0 restart the loop
	
	LC R3, OS_KBDR_ADDR		; R3 = keyboard data register address
	LDR R3, R3, #0			; R3 = contents of keyboard data register
	CMPI R3, #10
	BRZ FINISH_GETS 
	CMPI R0, #28
	BRZP FINISH_GETS
